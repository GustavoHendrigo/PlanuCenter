...
@Component({
  ...
  template: `
    <div class="flex h-full flex-col bg-gradient-to-b from-gray-950 via-gray-900 to-gray-800 text-gray-100">
      <div class="flex h-24 items-center gap-4 px-6">
        <div class="relative flex h-14 w-14 items-center justify-center overflow-hidden rounded-[1.75rem] bg-gradient-to-br from-cyan-500 via-blue-500 to-indigo-500 shadow-xl shadow-blue-900/50">
          <div class="absolute inset-0 opacity-40 [background:radial-gradient(circle_at_top,_rgba(255,255,255,0.35),_transparent_70%)]"></div>
          <span class="relative text-2xl font-black uppercase tracking-[-0.2em] text-white">
            <span class="text-cyan-50 drop-shadow-[0_6px_16px_rgba(8,145,178,0.55)]">P</span>
            <span class="ml-1 text-indigo-50 drop-shadow-[0_6px_16px_rgba(79,70,229,0.55)]">C</span>
          </span>
        </div>
        <div class="flex flex-col">
          <p class="text-xl font-extrabold tracking-tight text-white">
            <span class="bg-gradient-to-r from-cyan-200 via-blue-300 to-indigo-300 bg-clip-text text-transparent">Planu</span>
            <span class="ml-0.5">Center</span>
          </p>
          <div class="mt-1 h-px w-10 bg-gradient-to-r from-cyan-400/60 via-blue-400/50 to-transparent"></div>
          <p class="mt-1 text-[0.65rem] uppercase tracking-[0.45em] text-cyan-200/70">Operações inteligentes</p>
        </div>
      </div>
